...
public class MoveImage : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        xPosDiff = UnityEngine.Random.Range(-1f, 1f) * Mathf.PI * 2f;
        yPosDiff = UnityEngine.Random.Range(-1f, 1f) * Mathf.PI * 2f;
        zRotDiff = UnityEngine.Random.Range(-1f, 1f) * Mathf.PI * 2f;
        xScaleDiff = UnityEngine.Random.Range(-1f, 1f) * Mathf.PI * 2f;
        yScaleDiff = UnityEngine.Random.Range(-1f, 1f) * Mathf.PI * 2f;
    }
